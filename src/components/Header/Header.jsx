  ...
  return (
    <header className="header-app">
      ...
      <nav className="menu-navegacao">
        <button onClick={() => selecionarMenu("inicio")} disabled={menuSelecionado === "inicio"}>Painel</button>
        <button onClick={() => selecionarMenu("estacoes")} disabled={menuSelecionado === "estacoes"}>Todas as Estações</button>
